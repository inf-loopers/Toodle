        ...
        <aside className="hidden w-64 flex-col border-r border-slate-200 bg-white md:flex">
          ...
          <div className="border-t border-slate-100 p-4">
            <div className="rounded-xl bg-slate-50 p-3">
              ...
              <p className="mt-1 truncate text-xs text-slate-600">localhost:3000/api/v1</p>
            ...
            {pageComponents[activePage] ? (
              ...
              <>
                ...
                <div className="mb-8 flex flex-col justify-between gap-4 lg:flex-row lg:items-center">
                  <div>
                    <p className="text-sm font-medium text-blue-600">2026 Academic Year</p>

                    <h1 className="mt-1 text-3xl font-bold tracking-tight">Allocation Board</h1>
                ...
                <div className="mb-8 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                  <StatCard label="Courses" value="24" description="Courses requiring tutors" />
                  ...
                  <StatCard label="Assigned" value="52" description="Assignments currently made" />

                  <StatCard label="Unfilled" value="4" description="Courses still needing tutors" />
                </div>
                        ...
                        {allocations.map((allocation) => (
                          ...
                          >
                            <td className="px-5 py-4">
                              <p className="font-semibold text-slate-900">{allocation.course}</p>
                              <p className="mt-1 text-xs text-slate-400">{allocation.name}</p>
                            </td>
                            ...
                            <td className="px-5 py-4">
                              {allocation.tutor ? (
                                <div className="flex items-center gap-3">
                                  ...
                                  <div>
                                    <p className="text-sm font-medium">{allocation.tutor}</p>
                            ...
                            <td className="px-5 py-4 text-sm font-medium">{allocation.hours}h</td>
                            ...
                            <td className="px-5 py-4">
                              {allocation.status === 'Assigned' ? (
                                <div className="flex items-center gap-2">
                                  ...
                                  {allocation.locked && <span title="Locked">🔒</span>}
                                </div>
                              ) : (
                ...
                <div className="mt-6 grid gap-6 lg:grid-cols-2">
                  <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                    ...
                    <div className="mt-5 space-y-3">
                      ...
                      <div className="rounded-xl border border-red-100 bg-red-50/50 p-4">
                        ...
                        <p className="mt-1 text-xs text-slate-500">
                          One proposed assignment overlaps with a tutor's timetable.
                        </p>
                      </div>
                  ...
                  <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-slate-400">Sessions happening soon.</p>
                    </div>
